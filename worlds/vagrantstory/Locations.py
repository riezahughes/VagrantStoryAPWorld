...
location_tables = {
    "Ashley": [
        ...
        # Break Arts
        VagrantStoryLocationData("Break Art Dagger Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Dagger Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Dagger Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Dagger Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Sword Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Sword Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Sword Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Sword Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Sword Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Sword Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Sword Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Sword Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Axes & Maces Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Axes & Maces Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Axes & Maces Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Axes & Maces Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Axe Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Axe Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Axe Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Great Axe Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Stave Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Stave Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Stave Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Stave Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Heavy Mace Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Heavy Mace Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Heavy Mace Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Heavy Mace Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Polearm Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Polearm Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Polearm Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Polearm Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Crossbow Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Crossbow Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Crossbow Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Crossbow Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Bare Hands Level 1", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Bare Hands Level 2", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Bare Hands Level 3", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
        VagrantStoryLocationData("Break Art Bare Hands Level 4", "Vera Root", VagrantStoryLocationCategory.BREAK_UNLOCKS),
    ],
    "Prologue": [
