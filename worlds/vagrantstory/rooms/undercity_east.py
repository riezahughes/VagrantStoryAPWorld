room_data = {
    ...
    "The Greengrocer's Stair": {"exits": [("A Welcome Invasion", None), ("Where Black Waters Ran", None)]},
    "Where Black Waters Ran": {"exits": [("The Greengrocer's Stair", None), ("Arms Against Invaders", None)]},
    "Arms Against Invaders": {"exits": [("Where Black Waters Ran", None), ("Catspaw Blackmarket", None)]},
    "Catspaw Blackmarket": {"exits": [("Arms Against Invaders", None)]},
}
