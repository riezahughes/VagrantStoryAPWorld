room_data = {
    "Into Holy Battle": {"exits": [("Plateia Lumitar", None), ("Struggle for the Soul", None), ("The Convent Room", None)]},
    "The Poisoned Chapel": {"exits": [("Sin and Punishment", None), ("A Light in the Dark", "Laurel Sigil")]},
    "Sin and Punishment": {"exits": [("The Poisoned Chapel", "Flayed Confessional"), ("An Offering of Souls", None)]},
    "A Light in the Dark": {"exits": [("The Poisoned Chapel", None)]},
    "Monk's Leap": {"exits": [("The Acolyte's Weakness", None)]},
    "Hieratic Recollections": {"exits": [("The Flayed Confessional", None), ("Cracked Pleasures", None)]},
    "The Flayed Confessional": {"exits": [("Hieratic Recollections", None)]},
