room_data = {
    ...
    "Shrine to the Martyrs": {"exits": [("Persecution Hall", None), ("The Lamenting Mother", None), ("Hall of Dying Hope", None)]},
    "The Lamenting Mother": {"exits": [("Shrine to the Martyrs", None), ("The Last Stab of Hope", None)]},
    ...
    "The Last Stab of Hope": {"exits": [("Repent, O ye Sinners", None), ("The Lamenting Mother", None), ("Hallway of Heroes", None)]},
