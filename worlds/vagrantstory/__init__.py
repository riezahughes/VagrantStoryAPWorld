    ...
    def fill_slot_data(self) -> Dict[str, object]:
        ...
        slot_data = {
            "options": {
                ...
                "chain_skill_unlock_option": self.options.chain_skill_unlock_option,
                "chain_skill_counter": self.options.chain_skill_counter,
                "break_art_unlock_option": self.options.break_art_unlock_option,
                "break_art_counter": self.options.break_art_counter,
